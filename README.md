...
В проекте также сохранен Next.js-каркас и Prisma-схема для дальнейшего развития. В текущем Windows sandbox запуск Next/Prisma worker-процессов блокировался ошибкой `spawn EPERM`, поэтому рабочий MVP реализован как standalone Node.js сервер без дочерних процессов.
